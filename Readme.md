...
## 1. Project Overview
This project analyzes retail sales performance using three structured datasets: Customers, Orders, and Products. The objective is to extract actionable insights related to revenue performance, customer behaviour, product contribution, and operational efficiency.
